...
with open(os.path.join(data_path, 'dictionary.json'),encoding="utf-8") as fo: #My: Added encoding="utf-8"
    dict_word = json.load(fo)
with open(os.path.join(data_path, 'pinyin_vocab.json'),encoding="utf-8") as fo:
    dict_pinyin = json.load(fo)
with open(os.path.join(data_path, 'wubi_vocab.json'),encoding="utf-8") as fo:
