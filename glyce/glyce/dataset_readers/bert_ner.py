...
class MsraNERProcessor(DataProcessor):
    ...
    def get_train_examples(self, data_dir):
        # see base class 
        return self._create_examples(self._read_lsv(os.path.join(data_dir, "train.ner")), "train")

    def get_test_examples(self, data_dir):
        return self._create_examples(self._read_lsv(os.path.join(data_dir, "test.ner")), "test")


    def get_dev_examples(self, data_dir):
        return self._create_examples(self._read_lsv(os.path.join(data_dir, "dev.ner")), "dev")
...
class WeiboNERProcessor(DataProcessor):
    ...
    def get_train_examples(self, data_dir):
        # see base class
        return self._create_examples(self._read_lsv(os.path.join(data_dir, "train.all.bmes")), "train")

    def get_test_examples(self, data_dir):
        return self._create_examples(self._read_lsv(os.path.join(data_dir, "test.all.bmes")), "test")


    def get_dev_examples(self, data_dir):
        return self._create_examples(self._read_lsv(os.path.join(data_dir, "dev.all.bmes")), "dev")


    def get_labels(self):
        # see base class
        return ['B-GPE.NAM', 'B-GPE.NOM', 'B-LOC.NAM', 'B-LOC.NOM', 'B-ORG.NAM', 'B-ORG.NOM', 'B-PER.NAM', 'B-PER.NOM', 'E-GPE.NAM', 'E-GPE.NOM', 'E-LOC.NAM', 'E-LOC.NOM', 'E-ORG.NAM', 'E-ORG.NOM', 'E-PER.NAM', 'E-PER.NOM', 'M-GPE.NAM', 'M-LOC.NAM', 'M-LOC.NOM', 'M-ORG.NAM', 'M-ORG.NOM', 'M-PER.NAM', 'M-PER.NOM', 'O', 'S-GPE.NAM', 'S-LOC.NOM', 'S-PER.NAM', 'S-PER.NOM']
