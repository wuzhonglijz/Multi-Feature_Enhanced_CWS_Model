...
class CityuCWSProcessor(DataProcessor):
    # processor for Cityu CWS dataset
    def get_train_examples(self, data_dir):
        # see base class
        return self._create_examples(self._read_tsv(os.path.join(data_dir, "train.char.bmes")), "train")
...
class AsCWSProcessor(DataProcessor):
    # processor for AS CWS dataset
    def get_train_examples(self, data_dir):
        # see base class
        return self._create_examples(self._read_tsv(os.path.join(data_dir, "train.char.bmes")), "train")
...
class WeiboCWSProcessor(DataProcessor):
    # processor for Weibo CWS dataset
    def get_train_examples(self, data_dir):
        # see base class
        return self._create_examples(self._read_tsv(os.path.join(data_dir, "train.char.bmes")), "train")
